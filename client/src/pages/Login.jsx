...
export default function Login() {
  ...
  const { login, user, fetchUser } = useUserAuth();
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#F9FAFB] via-[#EEF2F7] to-[#E6ECF3] text-gray-700 px-4 py-10 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="backdrop-blur-md rounded-2xl shadow-xl w-full max-w-5xl flex flex-col lg:flex-row overflow-hidden border border-black/10 bg-white">
        {/* Left Section */}
        <div className="hidden lg:flex flex-col justify-center items-center w-full lg:w-1/2 p-10 text-center bg-gradient-to-br from-white to-[#f1f5f9]">
          <h2 className="text-3xl font-bold text-[#2563EB] mb-4">Welcome Back to BoomVerse</h2>
          <p className="text-gray-600 text-base leading-relaxed">
            Dive back into the world of creators. Explore, share, and grow your journey with your community!
          </p>
        </div>
        ...
        <div className="w-full lg:w-1/2 p-8 bg-white">
          <div className="max-w-md mx-auto animate-fade-in">
            <h2 className="text-3xl font-bold mb-6 text-center text-[#2563EB] flex items-center justify-center gap-2 md:hidden">
            Log In to BoomVerse
            </h2>
